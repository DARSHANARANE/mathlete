          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
            ...
            >
              ...
              <p className="text-gray-600 leading-8 mb-5">
                Mathlete is a competitive mathematics program designed
                to help children improve speed, confidence, and logical
                thinking through fun learning methods.
              </p>
            ...
            >
              <div className="w-full max-w-[450px] h-[320px] md:h-[400px] bg-[#fff5f5] rounded-2xl overflow-hidden shadow-md flex items-center justify-center">
